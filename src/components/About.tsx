...
export default function About() {
  ...
  useEffect(() => {
    const fetchAbout = async () => {
      ...
      if (docSnap && docSnap.value) {
        ...
        setData({
          title: "من نحن؟",
          description: 'نحن في "رؤيا" للتصميم والطباعة لسنا مجرد وكالة دعاية وإعلان، بل نحن شركاء نجاحك. نؤمن بأن كل علامة تجارية لها قصة فريدة تستحق أن تُروى بأفضل صورة ممكنة. نجمع بين الإبداع الفني والخبرة التقنية لنقدم لك حلولاً متكاملة تبرز هوية مشروعك.',
          features: [
  ...
  return (
    <section
      id="about"
      className="py-16 lg:py-24 lg:mt-20 bg-slate-900 border-b border-white/10 overflow-hidden"
      dir="rtl"
    >
